    ...
    <div class="container">
        <div class="publication-detail-card">
            ...
            <div style="margin-bottom: 2.5rem;">
                ...
                @php
                    $historyEntries = ($grant->workflow && $grant->workflow->history)
                        ? $grant->workflow->history->sortBy('created_at')->values()
                        : collect();
                    ...
                    if (!$hasDraftEntry && $grant->workflow && $grant->workflow->created_at) {
                        ...
                        $draftEntry->created_at = $grant->workflow->created_at;
                        $draftEntry->performer = $grant->workflow->submitter;
