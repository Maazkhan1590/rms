    ...
    <div class="container">
        <div class="publication-detail-card">
            ...
            <div class="publication-header">
                ...
                @php
                    $displayStatus = $investment->status;
                    $statusColors = [
            ...
            @if($investment->submitter || $investment->approver || isset($investment->faculty))
            <div style="margin-bottom: 2.5rem;">
                <h2 class="section-title">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $investment->submitter->name }}</div>
                        @if($investment->submitted_at)
                        <div style="font-size: 0.85rem; color: #6b7280; margin-top: 0.5rem;">
                            <i class="far fa-calendar"></i> {{ $investment->submitted_at->format('F d, Y') }}
                        </div>
                        @endif
                    </div>
                    @endif
                    ...
                    <div class="detail-item">
                        ...
                        @endif
                        <div class="detail-value">{{ $investment->approver->name }}</div>
                        @if($investment->approved_at)
                        <div style="font-size: 0.85rem; color: #6b7280; margin-top: 0.5rem;">
                            <i class="far fa-calendar"></i> {{ $investment->approved_at->format('F d, Y') }}
                        </div>
                        @endif
                    </div>
                    @endif

                    @if(isset($investment->faculty) && $investment->faculty)
                    <div class="detail-item">
                        <div class="detail-label"><i class="fas fa-university" style="margin-right: 0.5rem;"></i>Faculty</div>
                        <div class="detail-value">{{ $investment->faculty }}</div>
                    </div>
                    @endif
                </div>
            </div>
