...
@section('title', 'Submit Research Fellow | Academic Research Portal')
    ...
    <div class="container">
        <div class="auth-container">
            <div class="auth-header">
                <h1>Submit Research Fellow</h1>
                <p>Fill in the details below to submit your research fellow publication for approval</p>
            </div>
            <form method="POST" action="{{ route('research-fellows.store') }}" class="auth-form" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="status" name="status"
                                   value="{{ old('status') }}" placeholder="e.g., Published, Accepted">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="count_for_urc">Count for URC</label>
                            <input type="number" class="form-control" id="count_for_urc" name="count_for_urc" 
                                   min="0" value="{{ old('count_for_urc', 0) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="indexed" value="1" {{ old('indexed') ? 'checked' : '' }}>
                                Indexed
                            </label>
                        </div>
                    </div>
