...
@section('title', 'Submit Conference Activity | Academic Research Portal')
    ...
    <div class="container">
        <div class="auth-container">
            <div class="auth-header">
                <h1>Submit Conference Activity</h1>
                <p>Fill in the details below to submit your conference activity for approval</p>
            </div>
            <form method="POST" action="{{ route('conference-activities.store') }}" class="auth-form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label for="conference">
                        Conference <span style="color: var(--danger);">*</span>
                    </label>
                    <input type="text" class="form-control" id="conference" name="conference" required 
                           placeholder="e.g., IEEE ICASSP 2026"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="activity_type" name="activity_type">
                                ...
                                <option value="keynote" {{ old('activity_type') == 'keynote' ? 'selected' : '' }}>Keynote</option>
                                <option value="invited" {{ old('activity_type') == 'invited' ? 'selected' : '' }}>Invited</option>
                                <option value="regular" {{ old('activity_type') == 'regular' ? 'selected' : '' }}>Regular</option>
                                <option value="plenary" {{ old('activity_type') == 'plenary' ? 'selected' : '' }}>Plenary</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
