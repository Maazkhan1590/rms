    ...
    <div class="container">
        <div class="publication-detail-card">
            ...
            <div class="publication-header">
                ...
                @php
                    $displayStatus = $contribution->status;
                    $statusColors = [
            ...
            @if($contribution->submitter || $contribution->approver || isset($contribution->faculty))
            <div style="margin-bottom: 2.5rem;">
                <h2 class="section-title">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $contribution->submitter->name }}</div>
                        @if($contribution->submitted_at)
                        <div style="font-size: 0.85rem; color: #6b7280; margin-top: 0.5rem;">
                            <i class="far fa-calendar"></i> {{ $contribution->submitted_at->format('F d, Y') }}
                        </div>
                        @endif
                    </div>
                    @endif
                    ...
                    <div class="detail-item">
                        ...
                        @endif
                        <div class="detail-value">{{ $contribution->approver->name }}</div>
                        @if($contribution->approved_at)
                        <div style="font-size: 0.85rem; color: #6b7280; margin-top: 0.5rem;">
                            <i class="far fa-calendar"></i> {{ $contribution->approved_at->format('F d, Y') }}
                        </div>
                        @endif
                    </div>
                    @endif

                    @if(isset($contribution->faculty) && $contribution->faculty)
                    <div class="detail-item">
                        <div class="detail-label"><i class="fas fa-university" style="margin-right: 0.5rem;"></i>Faculty</div>
                        <div class="detail-value">{{ $contribution->faculty }}</div>
                    </div>
                    @endif
                </div>
            </div>
