...
<div class="publication-card">
    <div class="publication-card-header">
        <span class="publication-category">BLOCK FUNDING</span>
    ...
    <div class="publication-card-body">
        <h3 class="publication-card-title">
            <a href="{{ route('block-fundings.show', $funding->id) }}">
    ...
    <div class="publication-card-footer">
        <a href="{{ route('block-fundings.show', $funding->id) }}" class="btn btn-outline btn-sm">
