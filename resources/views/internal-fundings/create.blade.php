...
@section('title', 'Submit Internal Funding | Academic Research Portal')
    ...
    <div class="container">
        <div class="auth-container">
            <div class="auth-header">
                <h1>Submit Internal Funding</h1>
                <p>Fill in the details below to submit your internal funding record for approval</p>
            </div>
            <form method="POST" action="{{ route('internal-fundings.store') }}" class="auth-form" enctype="multipart/form-data">
                @csrf
