...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="mb-0">
            ...
            <span style="vertical-align: middle;">Internal Funding Details</span>
        </h3>
        <div>
            <a href="{{ route('admin.internal-fundings.index') }}" class="btn btn-secondary">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @include('admin.partials.workflow-timeline', ['workflow' => $funding->workflow])

                        @if(in_array($funding->workflow->status, ['pending_coordinator', 'pending_dean']) && $funding->workflow->assigned_to == auth()->id())
                        <div class="mt-3">
                            <form action="{{ route('admin.internal-fundings.approve', $funding->id) }}" method="POST" style="display: inline;">
                                @csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.internal-fundings.reject', $funding->id) }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Reject Internal Funding</h5>
