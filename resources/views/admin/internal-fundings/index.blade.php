...
<div class="card">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
            <div>
                <h3 style="margin: 0; display: inline-block;">
                    <i class="fas fa-money-bill-wave"></i> Internal Fundings Management
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="internal-fundings-table" class="table table-bordered table-striped table-hover" style="width:100%;">
                <thead>
                    <tr>
                        <th>Sr No</th>
                        <th>Project Title</th>
...
$(document).ready(function() {
    var table = $('#internal-fundings-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: '{{ route("admin.internal-fundings.index") }}',
            data: function(d) {
        ...
        pageLength: 25,
        language: {
            processing: '<i class="fas fa-spinner fa-spin"></i> Loading internal fundings...'
        }
    });
