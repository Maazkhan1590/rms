...
<div class="card">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
            <div>
                <h3 style="margin: 0; display: inline-block;">
                    <i class="fas fa-trophy"></i> Awards Management
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="awards-table" class="table table-bordered table-striped table-hover" style="width:100%;">
                <thead>
                    <tr>
                        <th>Sr No</th>
                        <th>Award Name</th>
...
$(document).ready(function() {
    var table = $('#awards-table').DataTable({
        ...
        pageLength: 25,
        language: {
            processing: '<i class="fas fa-spinner fa-spin"></i> Loading awards...'
        }
    });
