...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive" style="overflow-x: auto; -webkit-overflow-scrolling: touch;">
            <table id="rtn-table" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Title</th>
...
$(document).ready(function() {
    $('#rtn-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("admin.rtn-submissions.index") }}',
            type: 'GET'
        },
        columns: [
            { data: 'id', name: 'id' },
            { data: 'title', name: 'title', orderable: false },
            { data: 'rtn_type', name: 'rtn_type', orderable: false },
            { data: 'user_name', name: 'user_id', orderable: true },
            { data: 'evidence_link', name: 'evidence_link', orderable: false },
            { data: 'total_rtn', name: 'total_rtn', orderable: false },
            { data: 'year', name: 'year' },
