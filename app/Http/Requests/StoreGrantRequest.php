...
class StoreGrantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'grant_type' => 'required|in:external_grant,external_consultancy,matching_grant,grg_urg,patent_copyright,grant_application',
            'role' => 'required|in:PI,Co_PI,Co_I,Advisor_Mentor,Applicant',
            'amount_omr' => 'nullable|numeric|min:0',
            'currency' => 'nullable|string|max:3|default:OMR',
            'sponsor_name' => 'required|string|max:255',
            'sponsor_type' => 'nullable|in:government,private,international,other',
            'reference_code' => 'nullable|string|max:255',
            'start_date' => 'nullable|date',
            'end_date' => 'nullable|date|after_or_equal:start_date',
            'award_year' => 'required|integer|min:2000|max:' . (now()->year + 1),
