...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('commercializations', function (Blueprint $table) {
            $table->enum('status', ['draft', 'submitted', 'pending_coordinator', 'pending_dean', 'approved', 'rejected', 'returned'])->default('draft')->after('year');
            $table->foreignId('submitted_by')->nullable()->after('owner_team_id')->constrained('users')->nullOnDelete();
