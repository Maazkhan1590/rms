...
return new class extends Migration
{
    ...
    {
        Schema::table('consultancies_kts', function (Blueprint $table) {
            // Change status enum to include workflow statuses
            $table->enum('status', ['draft', 'submitted', 'pending_coordinator', 'pending_dean', 'approved', 'rejected', 'returned', 'ongoing', 'completed'])->default('draft')->change();
