...
return new class extends Migration
{
    ...
    {
        Schema::table('supervision_exams', function (Blueprint $table) {
            $table->enum('workflow_status', ['draft', 'submitted', 'pending_coordinator', 'pending_dean', 'approved', 'rejected', 'returned'])->default('draft')->after('status');
            ...
            $table->index(['submitted_by', 'workflow_status']);
    ...
    public function down(): void
    {
        Schema::table('supervision_exams', function (Blueprint $table) {
            ...
            $table->dropIndex(['submitted_by', 'workflow_status']);
            $table->dropIndex(['workflow_status', 'submitted_at']);
            $table->dropColumn([
                'workflow_status',
                'submitted_by',
                'approver_id',
