...
return new class extends Migration
{
    ...
    {
        Schema::table('editorial_appointments', function (Blueprint $table) {
            $table->enum('status', ['draft', 'submitted', 'pending_coordinator', 'pending_dean', 'approved', 'rejected', 'returned'])->default('draft')->after('notes');
